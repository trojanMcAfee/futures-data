## [Direct link to heading](https://docs.etherscan.io/holesky-etherscan/api-endpoints/blocks?fallback=true\#get-block-and-uncle-rewards-by-blockno)    Get Block And Uncle Rewards by BlockNo
