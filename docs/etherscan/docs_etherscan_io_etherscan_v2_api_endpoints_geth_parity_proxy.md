...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_blocknumber)    **eth\_blockNumber**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_blockNumber&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_getblockbynumber)    **eth\_getBlockByNumber**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getBlockByNumber&tag=0x10d4f&boolean=true&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_getunclebyblocknumberandindex)    **eth\_getUncleByBlockNumberAndIndex**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getUncleByBlockNumberAndIndex&tag=0xC63276&index=0x0&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_getblocktransactioncountbynumber)    **eth\_getBlockTransactionCountByNumber**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getBlockTransactionCountByNumber&tag=0x10FB78&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_gettransactionbyhash)    **eth\_getTransactionByHash**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getTransactionByHash&txhash=0xbc78ab8a9e9a0bca7d0321a27b2c03addeae08ba81ea98b03cd3dd237eabed44&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_gettransactionbyblocknumberandindex)    **eth\_getTransactionByBlockNumberAndIndex**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getTransactionByBlockNumberAndIndex&tag=0xC6331D&index=0x11A&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_gettransactioncount)    **eth\_getTransactionCount**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getTransactionCount&address=0x4bd5900Cb274ef15b153066D736bf3e83A9ba44e&tag=latest&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_sendrawtransaction)    **eth\_sendRawTransaction**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_sendRawTransaction&hex=0xf904808000831cfde080&apikey=YourApiKeyToken) 🔗
...
🖋️ For more information on creating a **signed raw transaction**, visit this [**page.**](https://docs.etherscan.io/etherscan-v2/tutorials/signing-raw-transactions)
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_gettransactionreceipt)    **eth\_getTransactionReceipt**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getTransactionReceipt&txhash=0xadb8aec59e80db99811ac4a0235efa3e45da32928bcff557998552250fa672eb&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_call)    **eth\_call**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_call&to=0xAEEF46DB4855E25702F8237E8f403FddcaF931C0&data=0x70a08231000000000000000000000000e16359506c028e51f16be38986ec5746251e9724&tag=latest&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_getcode)    **eth\_getCode**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getCode&address=0xf75e354c5edc8efed9b59ee9f67a80845ade7d0c&tag=latest&apikey=YourApiKeyToken) 🔗
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_getstorageat)    **eth\_getStorageAt**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_getStorageAt&address=0x6e03d9cce9d60f3e9f2597e13cd4c54c55330cfd&position=0x0&tag=latest&apikey=YourApiKeyToken)
...
## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_gasprice)    **eth\_gasPrice**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_gasPrice&apikey=YourApiKeyToken) 🔗
...
Easily convert Ethereum units using our [**unit converter.**](https://etherscan.io/unitconverter)

## [Direct link to heading](https://docs.etherscan.io/etherscan-v2/api-endpoints/geth-parity-proxy\#eth_estimategas)    **eth\_estimateGas**
...
> Try this endpoint in your [**browser**](https://api.etherscan.io/v2/api?chainid=1&module=proxy&action=eth_estimateGas&data=0x4e71d92d&to=0xf0160428a8552ac9bb7e050d90eeade4ddd52843&value=0xff22&gasPrice=0x51da038cc&gas=0x5f5e0ff&apikey=YourApiKeyToken) 🔗
...
[PreviousLogs](https://docs.etherscan.io/etherscan-v2/api-endpoints/logs) [NextTokens](https://docs.etherscan.io/etherscan-v2/api-endpoints/tokens)
